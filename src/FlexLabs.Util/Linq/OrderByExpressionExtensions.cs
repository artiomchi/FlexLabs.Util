...
namespace FlexLabs.Linq
{
    ...
    {
        public static IOrderedQueryable<TModel> OrderBy<TModel, TKey>(this IQueryable<TModel> source, OrderByExpressionCollection<TKey, TModel> sorter, TKey sortBy, Boolean sortAsc)
        {
